...
// Importa el módulo de seguridad
const security = require("./security");
// Importa el módulo de respuesta personalizada
const response = require("../../red/response");
// Importa el controlador relacionado
const controller = require("./index");

// Crea un enrutador Express
const router = express.Router();

// Define las rutas y asocia las funciones de controlador correspondientes
router.get("/", getAll);
router.get("/:id", get);
router.post("/", add);
